<?php
	...
	$str = strip_tags(trim($_POST['ct'])); // variable that stores title of the category selected by user
	$query = "SELECT * FROM menu WHERE category = '$str'"; //query that allows to get informaton about all selected category foods from database
